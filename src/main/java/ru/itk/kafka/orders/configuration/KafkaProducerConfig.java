...
public class KafkaProducerConfig {
    ...
    public NewTopic newOrderTopic() {
        return TopicBuilder
                .name(kafkaProperties.getOrderNewTopicName())
                .replicas(kafkaProperties.getOrderNewTopicReplicas())
                .partitions(kafkaProperties.getOrderNewTopicPartitions())
                .configs(Map.of("min.insync.replicas", "2"))
                .build();
    }

    @Bean
    public NewTopic newOrderDlqTopic() {
        return TopicBuilder
                .name(kafkaProperties.getOrderNewDlqTopicName())
                .replicas(kafkaProperties.getOrderNewDlqTopicReplicas())
                .partitions(kafkaProperties.getOrderNewTopicDlqPartitions())
