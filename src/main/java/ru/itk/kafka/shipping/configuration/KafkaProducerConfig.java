...
public class KafkaProducerConfig {
    ...
    public NewTopic sentOrderTopic() {
        return TopicBuilder
                .name(kafkaProperties.getSentOrdersTopicName())
                .replicas(kafkaProperties.getSentOrdersTopicReplicas())
                .partitions(kafkaProperties.getSentOrdersTopicPartitions())
                .configs(Map.of("min.insync.replicas", "2"))
                .build();
    }

    @Bean
    public NewTopic sentOrderDlqTopic() {
        return TopicBuilder
                .name(kafkaProperties.getSentOrdersDlqTopicName())
                .replicas(kafkaProperties.getSentOrdersDlqTopicReplicas())
                .partitions(kafkaProperties.getSentOrdersDlqTopicPartitions())
